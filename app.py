...
MIN_ACTIVITY_YEAR = datetime.now().year - 150  # allow a 1.5 century back for historical logging
MAX_ACTIVITY_YEAR = datetime.now().year + 3  # allow a couple of years into the future for planning
...
def parse_activity_date(date_str):
    ...
    malformed or outside the 1900–2026 window.
    """
    try:
